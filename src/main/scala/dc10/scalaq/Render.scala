...
import dc10.scala.Symbol.Term.TypeLevel.App.App1
import dc10.scala.Symbol.Term.TypeLevel.App.App2
import dc10.scala.Symbol.Term.TypeLevel.App.App2T
import dc10.scala.Symbol.Term.TypeLevel.App.App3
import dc10.scala.Symbol.Term.TypeLevel.App.Infix
import dc10.scala.Symbol.Term.TypeLevel.Lam.Function1Type
import dc10.scala.Symbol.Term.TypeLevel.Lam.Function2Type
...
import dc10.scala.Symbol.Term.TypeLevel.Var.UnitType
import dc10.scala.Symbol.Term.TypeLevel.Var.ListType
import dc10.scala.Symbol.Term.TypeLevel.Var.OptionType
import dc10.scala.Symbol.Term.TypeLevel.Var.SomeType
import dc10.scala.Symbol.Term.TypeLevel.Var.TupleType
  ...
  new Renderer["Twelf 1.7.1+", Error, List[Statement]]:
    ...
    private def renderType[Z, T, Y](tpe: Term.TypeLevel[T, Z]): String =
      tpe match
        ...
        // SO, Z needs to be a valueexpr?
        case Term.TypeLevel.Var.UserDefinedType(q, s, i, z) =>  z.toString + s"${s.toLowerCase()} N"
    ...
    private def renderValue[Z, T, X](value: Term.ValueLevel[T, Z]): String =
      value match 
        ...
        case Term.ValueLevel.Var.UserDefinedValue(q, s, t, i) => t match
          case App1(qnt, tfun, targ, dep) => ???
          case App2(qnt, tfun, ta, tb, dep) => ???
          case App2T(qnt, tfun, ta1, ta2, tb, dep) => ???
          case App3(qnt, tfun, ta1, ta2, tb, dep) => ???
          case Infix(qnt, tfun, ta, tb, dep) => ???
          case Function1Type(qnt, dep) => ???
          case Function2Type(qnt, dep) => ???
          case BooleanType(qnt, dep) => ???
          case IntType(qnt, dep) => ???
          case StringType(qnt, dep) => ???
          case UnitType(qnt) => ???
          case ListType(qnt, dep) => ???
          case OptionType(qnt, dep) => ???
          case SomeType(qnt, dep) => ???
          case TupleType(qnt, dep) => ???
          case UserDefinedType(qnt, nme, impl, dep) => s"$s"
