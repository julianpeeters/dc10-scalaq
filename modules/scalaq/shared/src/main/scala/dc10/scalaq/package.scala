package dc10.scalaq
  ...
  extension [T, Z] (t: Term.TypeLevel[T, Z])
    def manageDep[ZZ](f: Term.ValueLevel[Z, Any] => Term.ValueLevel[ZZ, Any]): Term.TypeLevel[T, ZZ] =
      t match
        ...
        case Term.TypeLevel.App.App2T(qnt, tfun, ta, tb, r, dep) => Term.TypeLevel.App.App2T(qnt, tfun, ta.manageDep(f), tb.manageDep(f), r.manageDep(f), f(dep))
  ...
  extension [T, Z] (v: Term.ValueLevel[T, Z])
    private def manageDep[ZZ](f: Term.ValueLevel[Z, Any] => Term.ValueLevel[ZZ, Any]): Term.ValueLevel[T, ZZ] =
      v match
        ...
        case Term.ValueLevel.Blc.ForComp(qnt, gens, tpe, dep) => ???
        ...
        case Term.ValueLevel.Var.UnitLiteral(qnt, tpe, u) => Term.ValueLevel.Var.UnitLiteral(qnt, tpe.manageDep(f), u)
    ...
    private def findImpl: Option[Term.ValueLevel[T, Z]] =
      v match
        ...
        case Term.ValueLevel.Blc.ForComp(qnt, a, gens, tpe) => Some(v)
        ...
        case Term.ValueLevel.Var.UnitLiteral(qnt, tpe, u) => Some(v)
    ...
    private def findVargs[U, A]: Option[Seq[Term.ValueLevel[U, A]]] =
      v.findImpl.fold(None)(i => i match
        ...
        case Term.ValueLevel.Blc.ForComp(qnt, a, gens, tpe) => None
        ...
        case Term.ValueLevel.Var.UnitLiteral(qnt, tpe, u) => None
